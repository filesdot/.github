...
<p align="center">
  ...
  <a href="#-adding-a-new-resource">➕ Add Resource</a> •
  <a href="#%EF%B8%8F-formatting-guidelines">✏️ Formatting</a> •
  <a href="#-pull-request-process">🔄 Submit PR</a> •
...
- [➕ Adding a New Resource](#-adding-a-new-resource)
  - [Step 1: Verify Eligibility](#step-1-verify-eligibility)
  - [Step 2: Choose the Right Category](#step-2-choose-the-right-category)
  - [Step 3: Format Your Entry](#step-3-format-your-entry)
  - [Step 4: Add Metadata Tags](#step-4-add-metadata-tags)
  - [Step 5: Write a Great Description](#step-5-write-a-great-description)
- [✏️ Formatting Guidelines](#%EF%B8%8F-formatting-guidelines)
  - [Markdown Standards](#markdown-standards)
  - [Link Rules](#link-rules)
  - [Category Headers](#category-headers)
  - [Tables (When Applicable)](#tables-when-applicable)
- [✅ Quality Standards](#-quality-standards)
  - [For Tools/Applications](#for-toolsapplications)
  - [For Themes/Collections](#for-themescollections)
  - [For Tutorials/Guides](#for-tutorialsguides)
  - [For Wallpapers/Assets](#for-wallpapersassets)
- [🔄 Pull Request Process](#-pull-request-process)
  - [1. Before You PR](#1-before-you-pr)
  - [2. PR Title Format](#2-pr-title-format)
  - [3. PR Description Template](#3-pr-description-template)
  - [4. After Submitting](#4-after-submitting)
- [🔍 Review Criteria](#-review-criteria)
  - [✅ Acceptance Criteria](#-acceptance-criteria)
  - [⚠️ Common Reasons for Requesting Changes](#%EF%B8%8F-common-reasons-for-requesting-changes)
  - [❌ Automatic Rejection Triggers](#-automatic-rejection-triggers)
- [❌ What We Don't Accept](#-what-we-dont-accept)
  ...
  - [Ethical Restrictions](#ethical-restrictions)
- [💡 Pro Tips](#-pro-tips)
  - [For Faster Reviews](#for-faster-reviews)
  - [For Better Descriptions](#for-better-descriptions)
  - [For Finding the Right Category](#for-finding-the-right-category)
  - [For Maintaining Your Entry](#for-maintaining-your-entry)
- [🆘 Getting Help](#-getting-help)
  - [Stuck? Try These:](#stuck-try-these)
  - [Need to Discuss First?](#need-to-discuss-first)
...
| Goal | Steps |
|------|-------|
| **➕ Add a new tool/theme** | 1. Read [Quality Standards](#-quality-standards) → 2. Format entry per [Guidelines](#-formatting-guidelines) → 3. Submit PR |
...
> ❓ **Not sure where it fits?** [Open an Issue](https://github.com/filesdot/resources/issues/new) to discuss first!
