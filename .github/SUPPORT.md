...
This is a **community-curated list** of Linux desktop customization resources. We do **not** provide:
- Official technical support for listed tools
- Bug fixes for upstream projects
- Configuration troubleshooting for every WM/DE combo

Instead, we help you **discover** awesome resources and **connect** with communities that do.
...
2. **Be specific**: Include distro, WM/DE version, error logs, and config snippets
3. **Use code blocks**: Wrap configs/terminal output in ``` markdown fences
...
## 🛡️ Paid Support
This project is **100% free and community-driven**. No paid support tiers exist. If you need professional help, consider:
- Hiring a Linux consultant
- Joining paid community servers (search our Discord `#resources` channel)
- Using enterprise distros (Red Hat, SUSE, Ubuntu Pro)
